...
import { getLatestApprovedListings } from "../Services/operations/itemOperation";
...
const Home = () => {
  ...
  useEffect(() => {
    const fetchListings = async () => {
      const data = await getLatestApprovedListings();
      setItemData(data);
      // setLoading(false);
    };
  ...
  // const [listingsListings] = useState([]);
      ...
      <div className="relative w-full rounded-3xl overflow-hidden mb-20">
        ...
        >
          ...
          <p className="mt-2 text-center max-w-xl text-gray-200">
            Get any product at affordable rental prices or start earning by
            listing your unused items on{" "}
            ...
            {[
              {
                ...
                image: slider1,
                review:
                  "Amazing service! Got a premium sofa for a great price.",
                rating: 5,
                price: "₹499 / month",
              },
              {
                ...
                image: slider2,
                review:
                  "The sofa was in perfect condition. Hassle-free rental!",
                rating: 4,
                price: "₹999 / month",
              },
              {
              ...
              <div key={index} className="px-4">
                ...
                >
                  <div
                    className="p-5 rounded-2xl bg-[#adb5bd] backdrop-blur-md border border-white/40
                      shadow-lg hover:shadow-2xl transition-all duration-300
                      relative overflow-hidden  cursor-pointer"
                  >
                    {/* Glow Border (Animated) */}
                    <div
                      className="absolute inset-0 rounded-2xl border-[1px] border-[#adb5bd] 
                    ...
                    {/* Review */}
                    <p className="mt-3 text-gray-100 text-sm italic">
                      "{item.review}"
                    </p>
